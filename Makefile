...
# Test files
TEST_SRCS = tests/catch_amalgamated.cpp tests/test_main.cpp tests/test_object.cpp tests/test_camera.cpp tests/test_card.cpp tests/test_chip.cpp tests/test_chip_stack.cpp tests/test_deck.cpp tests/test_inventory.cpp tests/test_dom.cpp tests/test_interactable.cpp tests/test_item.cpp tests/test_weapon.cpp tests/test_substance.cpp tests/test_fent.cpp tests/test_person.cpp tests/test_player.cpp tests/test_enemy.cpp tests/test_dealer.cpp tests/test_spawner.cpp tests/test_floor.cpp tests/test_ceiling.cpp tests/test_wall.cpp tests/test_light.cpp tests/test_lighting_manager.cpp tests/test_light_bulb.cpp tests/test_physics.cpp tests/test_rigidbody.cpp tests/test_pistol.cpp tests/test_poker_table.cpp tests/test_inventory_ui.cpp tests/test_render_utils.cpp tests/test_insanity_manager.cpp tests/test_death_scene.cpp tests/test_level_manager.cpp tests/test_level_generator.cpp tests/test_hospital_scene.cpp tests/test_stairs.cpp tests/test_psychedelic_manager.cpp tests/test_salvia.cpp
